...
CREATE TABLE [dbo].[TBTREINA_COLABORADOR] (
    ...
    [TIPO_TREINAMENTO]     NVARCHAR (50)  NULL,
    [ARQUIVO_ANEXO]        NVARCHAR (255) NULL,
...
-- Criação tabela TBROLE
CREATE TABLE [dbo].[TBROLE] (
    [ID_ROLE]   INT           IDENTITY (1, 1) NOT NULL,
    [NOME_ROLE] NVARCHAR (50) NOT NULL,
    [DESCRICAO] NVARCHAR (255) NULL,
    [DATA_CADASTRO] DATETIME DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT [PK_TBROLE] PRIMARY KEY CLUSTERED ([ID_ROLE] ASC)
);

-- Criação tabela TBPERMISSAO

CREATE TABLE [dbo].[TBPERMISSION] (
    [ID_PERMISSION]   INT            IDENTITY (1, 1) NOT NULL,
    [NOME_PERMISSION] NVARCHAR (50)  NOT NULL,
    [DESCRICAO]       NVARCHAR (255) NULL,
    CONSTRAINT [PK_TBPERMISSION] PRIMARY KEY CLUSTERED ([ID_PERMISSION] ASC)
);

-- Criação tabela TBROLE_PERMISSION

CREATE TABLE [dbo].[TBROLE_PERMISSION] (
    [ID_ROLE]       INT NOT NULL,
    [ID_PERMISSION] INT NOT NULL,
    CONSTRAINT [FK_TBROLE_PERMISSION_TBROLE] FOREIGN KEY ([ID_ROLE]) REFERENCES [dbo].[TBROLE]([ID_ROLE]),
    CONSTRAINT [FK_TBROLE_PERMISSION_TBPERMISSION] FOREIGN KEY ([ID_PERMISSION]) REFERENCES [dbo].[TBPERMISSION]([ID_PERMISSION])
);


-- Criação tabela TBUSUARIO
CREATE TABLE [dbo].[TBUSUARIO] (
    ...
    CONSTRAINT [PK_TBUSUARIO] PRIMARY KEY CLUSTERED ([ID_USUARIO] ASC),
    CONSTRAINT [FK_TBUSUARIO_TBROLE] FOREIGN KEY ([ID_ROLE]) REFERENCES [dbo].[TBROLE] ([ID_ROLE])
);

-- Criação da tabela TBLOG
CREATE TABLE [dbo].[TBLOG] (
    ...
    [DADOS_ANTERIORES] TEXT, -- Armazenar os dados anteriores em json
    [DADOS_NOVOS] TEXT, -- Armazenar os dados atuais em json
    [DATA_HORA]     DATETIME DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT [PK_TBLOG] PRIMARY KEY CLUSTERED ([ID_LOG] ASC),
    CONSTRAINT [FK_TBLOG_TBUSUARIO] FOREIGN KEY ([ID_USUARIO]) REFERENCES [dbo].[TBUSUARIO] ([ID_USUARIO])
);